...
\begin{figure}[H]
    \centering
	\includegraphics[scale=0.8]{../figures/physics_engine_flow_chart.pdf}
...
\begin{figure}[H]
	...
	\caption{HVL experiment of Al. (a) HVL, (b) QVL.}
...
\begin{figure}[H]
	...
	\caption{Radiography full-field $0^\circ$ ROI at 56.4 keV. (a) primary, (b) incoherent, (c) coherent, (d) multiple.}
	\label{figure:HVLGraph}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Radiography pencil $0^\circ$ ROI at 56.4 keV. (a) incoherent, (b) coherent, (c) multiple.}
	\label{figure:HVLGraph}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Radiography body deposition full-field. (a) 0 degree, (b) 15 degree.}
	\label{figure:HVLGraph}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Radiography VOI deposition full-field. (a) $0^\circ$, 56.4 keV; (b) $0^\circ$, 120 kVp; (c) $15^\circ$, 56.4 keV; (d) $15^\circ$, 120 kVp}
	\label{figure:HVLGraph}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{CT of voxelized geometry at $180^\circ$ and 56.4 keV.}
	\label{figure:HVLGraph}
\end{figure}
